...
class TextStyles {
  ...
  static TextStyle font12Black600 = TextStyle(
  ...
  static TextStyle font20Black700 = TextStyle(
      fontSize: 20.sp, color: Colors.black, fontWeight: FontWeight.w700);
  static TextStyle font12White500 = TextStyle(
      fontSize: 12.sp, color: Colors.white, fontWeight: FontWeight.w500);
  static TextStyle font30Black700 = TextStyle(
      fontSize: 30.sp, color: Colors.black, fontWeight: FontWeight.w700);*/
}
